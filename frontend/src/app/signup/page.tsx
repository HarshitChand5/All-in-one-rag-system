    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 bg-[#000000]">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[#86868b] text-[14px] mt-1">Get started with DocuRAG</p>
        </div>
        ...
        <div className="bg-[#1d1d1f] border border-white/10 rounded-2xl p-6">
          ...
          <form action={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              <Label htmlFor="full_name" className="text-[12px] text-[#86868b] uppercase tracking-wider font-semibold">Full Name</Label>
              <Input
                id="full_name"
                name="full_name"
                type="text"
